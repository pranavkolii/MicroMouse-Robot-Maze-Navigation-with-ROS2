...
namespace micromouse {
  MicroMouseNode::MicroMouseNode() : Node("micromouse_node") {
  ...
  bool MicroMouseNode::is_standalone_mode() const {
  ...
  void MicroMouseNode::log(const std::string& msg) {
    RCLCPP_INFO(this->get_logger(), "%s", msg.c_str());
    std::cerr << "[LOG] " << msg << std::endl;
  }

  bool MicroMouseNode::in_bounds(const Cell& c) const {
  ...
  // DFS Path Planning
  // =========================================================================
  std::optional<std::vector<Cell>> MicroMouseNode::dfs_plan(const Cell& start,
                                            const Cell& goal) {
